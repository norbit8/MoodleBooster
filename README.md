...
- Download Firefox ([🔥Download🔥](https://www.mozilla.org/en-US/firefox/new/)).
...
- From the root directory of the project run `npm run start` to start firefox with the web extension, then browse to moodle (For example [HUJI Moodle](https://moodle2.cs.huji.ac.il/).
